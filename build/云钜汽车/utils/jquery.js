...
var t = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ?
  function (n) {
    ...
    isPlainObject: function (n) {
      ...
      if (s.support.ownLast) for (r in n) return a.call(n, r);
      for (r in n);
    ...
    each: function (n, t, e) {
      var i = 0,
        ...
        u = r(n);
      if (e) {
        if (u) for (; i < o && !1 !== t.apply(n[i], e); i++);
        else for (i in n) if (!1 === t.apply(n[i], e)) break
      } else if (u) for (; i < o && !1 !== t.call(n[i], i, n[i]); i++);
    ...
    merge: function (n, r) {
      var t = r.length,
        e = n.length,
        i = 0;
      if ("number" == typeof t) for (; i < t; i++) n[e++] = r[i];
      else for (; void 0 !== r[i];) n[e++] = r[i++];
      return n.length = e, n
    },
    isMobile: function (n) {
      return "" !== s.trim(n) && /^\d{11}$/.test(s.trim(n))
    },
...
s.extend = function () {
  var n, r, e, i, o, u, f = arguments[0] || {},
    ...
    c = arguments.length,
    l = !1;
  for ("boolean" == typeof f && (l = f, f = arguments[1] || {}, a = 2), "object" === (void 0 === f ? "undefined" : t(f)) || s.isFunction(f) || (f = {}), c === a && (f = this, --a); a < c; a++) if (null != (n = arguments[a])) for (r in n) e = f[r], i = n[r], f !== i && (l && i && (s.isPlainObject(i) || (o = s.isArray(i))) ? (o ? (o = !1, u = e && s.isArray(e) ? e : []) : u = e && s.isPlainObject(e) ? e : {}, f[r] = s.extend(l, u, i)) : void 0 !== i && (f[r] = i));
  return f
