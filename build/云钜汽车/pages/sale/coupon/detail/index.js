...
Page({
  ...
  receive: function (e) {
    var i = this.data.detail,
      o = this;
    if (this.data.buying) return void a.toast(o, "正在执行请稍后");
    if (1 != i.canget) return void a.toast(o, i.getstr);
    var r = "确认使用";
        ...
        function () {
          o.setData({
            ...
            t.post("sale/coupon/pay", {
              ...
              function (e) {
                if (e.error > 0) return a.toast(o, e.message),
                  void o.setData({
                    buying: !1
                  });
                o.setData({
                  ...
                  e.wechat && e.wechat.success ? t.pay(e.wechat.payinfo,
                    function (e) {
  ...
  payResult: function () {
    ...
    t.get("sale/coupon/payresult", {
      ...
      function (i) {
        if (i.error > 0) return void a.toast(e, i.message);
        if (0 == i.coupontype) return void wx.redirectTo({
